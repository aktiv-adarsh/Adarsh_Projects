...
class StudentFees(models.Model):
    ...
    fees_student_phone_no = fields.Char(related='fees_student_id.student_phone', string="Contact No.")
    ...
    #     res = []
    #     print("\n\n ---------FEES-- IN FUNC -----------\n\n")
    #     if self._context.get('fees_student_name'):
    #         print("\n\n--------fees_student_name -- ", self.fees_student_name)
    #         for field in self:
    #             res.append((field.id, '%s - %s' % (field.fees_student_id, field.fees_student_name)))
    #             print("\n\n----FEES--ELSE--RES -- ", res)
    ...
    #
    #
    #     print("\n\n-----Customer country--------", self.fees_student_id)
    #     print("-----Customer Name ------------------", self.fees_student_name)
    #     print("-----Only Field ------------------", self)
    #
    #     # else:
    #     # for field in self:
