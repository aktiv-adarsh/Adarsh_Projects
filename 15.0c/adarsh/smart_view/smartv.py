...
#     ]
    ...
    @api.onchange('m2o_fields_id')
    def onchange_m2o_fields_id(self):
        print("Onchange called")
        if self.m2o_fields_id:
            if self.m2o_fields_id.email:
                self.email = self.m2o_fields_id.email
